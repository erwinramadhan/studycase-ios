...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let qrisVC = UINavigationController(rootViewController: QRISRouter.createModule())
        let promoVC = UINavigationController(rootViewController: PromoRouter.createModule())
        let portfolioVC = UINavigationController(rootViewController: PortfolioRouter.createModule())
        ...
        tabbar.viewControllers = [qrisVC, promoVC, portfolioVC]
